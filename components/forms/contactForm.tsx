...
// // import { z, type ZodMiniBoolean, type ZodMiniString } from "zod/mini";
// import Icon, { type LucideIconName } from "@/components/ui/lucideIcons";
...
//                 .map((pkg) => ({ ...pkg, icon: pkg.icon as LucideIconName })),
//             options_2: packages
...
// function standardResolver<T extends FieldValues>(schema: z.ZodMiniType<T>): Resolver<T> {
...
//             >
//                 <Icon
//                     name={iconName || "file-question-mark"}
...
// function SelectCustomItem({ option }: { option: ThePackage }) {
//     return (
...
//                           .boolean()
//                           .check(
//                               z.refine((val) => val === true, { message: t("required") })
//                           )
//                     : z.boolean();
//                 break;
...
//                 if (field.isRequired) {
//                     shape[key] = emailSchema.check(
//                         z.minLength(1, { message: t("required") }),
//                         z.refine((val) => emailRegex.test(val), {
...
// export type Package = MessagesMap["offer"] extends { packages: (infer U)[] } ? U : never;
...
// type ThePackage = Omit<Package, "icon"> & {
//     icon: LucideIconName;
// };
...
//     options_1: ThePackage[];
//     options_2: ThePackage[];
//     options_0: ThePackage[];
// };
